...
reuse should cite the authors and this repository. Third-party data are not
embedded except where aggregate, de-identified values are reported as Source
Data under the study's analysis and citation framework.

`source_data/scDesignGuard_Nature_Methods_SOURCE_DATA.xlsx` is the canonical
public aggregate-data artifact. Verify its frozen numerical claims with:
